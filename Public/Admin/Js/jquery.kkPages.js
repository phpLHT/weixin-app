...
(function($){
	...
	$.fn.kkPages = function(options){
		...
		return this.each(function(){		
			...
			// 定义分页导航
			var PagesNavHtml = "<div class=\"Pagination\"><a href=\"#top\" class=\"PagePrev\"><</a><span class=\"Ellipsis\"><b>...</b></span><div class=\"pagesnum\"></div><span class=\"Ellipsis\"><b>...</b></span><a href=\"#top\" class=\"PageNext\">></a></div>";
			...
			if($AllMth > $Mth){
					...
					var PagesMthTxt = "<span>共<b>"+PagesMth+"</b>页</span>";
					...
					// 计算分页导航显示数量
						...
						for(var i=1;i<=PagesMth;i++){
							...
							PagesNavNum = PagesNavNum + "<a href=\"#top\">"+i+"</a>";
